    ...
    <div id="header">
        ...
        <div class="product-info">
            <p class="product-name">Clean Air Dashboard</p>
            <div class="profile-info">
                <a href="https://cleanair.bihar.gov.in/admin/staff/edit_profile">
                    <span>Member Secretary (State Admin) ,Bihar State Pollution Control Board- State Admin </span>
                </a>
            </div>
        </div>
        <div id="logo">
        ...
        <nav>
            <div class="small-logo">
                <span class="text-primary">
                    <a href="https://cleanair.bihar.gov.in/admin/" class="logo img-responsive">
                        <img src="https://cleanair.bihar.gov.in/uploads/company/logo.jpg" class="img-responsive" alt="Clean Air Dashboard">
                    </a>            </span>
            </div>
            <div class="mobile-menu">
                ...
                <div class="mobile-navbar collapse" id="mobile-collapse" aria-expanded="false" style="height: 0px;" role="navigation">
                    <ul class="nav navbar-nav">
                        <li class="header-my-profile"><a href="https://cleanair.bihar.gov.in/admin/profile">My Profile</a></li>
                        <li class="header-my-timesheets"><a href="https://cleanair.bihar.gov.in/admin/staff/timesheets">My Timesheets</a>
                        </li>
                        <li class="header-edit-profile"><a href="https://cleanair.bihar.gov.in/admin/staff/edit_profile">Edit Profile</a>
                        </li>
                        <li class="header-newsfeed">
                            <a href="#" class="open_newsfeed mobile">
                                Share documents, ideas..                            </a>
                        </li>
                        <li class="header-logout"><a href="javascript:void(0)" onclick="logout(); return false;">Logout</a></li>
                    </ul>
                </div>
            </div>
            <ul class="nav navbar-nav navbar-right m-0">
                <li class="partner-logo">
                    <img src="https://cleanair.bihar.gov.in/uploads/logo/1623938678-IMG-20210305-WA0000_(1).jpg" alt="" style="width: 75px;height: 55px;">
                </li>
            </ul>
        </nav>
    ...
    <div id="setup-menu-wrapper" class="animated ">
        <ul class="nav metis-menu" id="setup-menu">
            ...
            <li class="menu-item-staff">
                <a href="https://cleanair.bihar.gov.in/admin/staff" aria-expanded="false">
                    <i class=" menu-icon"></i>
            ...
            <li class="menu-item-support">
                ...
                <ul class="nav nav-second-level collapse" aria-expanded="false">
                    <li class="sub-menu-item-region"><a href="https://cleanair.bihar.gov.in/admin/region">
                        <span class="sub-menu-text">
                            Region                      </span>
                    </a>
                    </li>
                    <li class="sub-menu-item-subregion"><a href="https://cleanair.bihar.gov.in/admin/subregion">
                        <span class="sub-menu-text">
                            Sub-region                      </span>
                    </a>
                    </li>
            ...
            <li class="menu-item-email-templates">
                <a href="https://cleanair.bihar.gov.in/admin/emails" aria-expanded="false">
                    <i class=" menu-icon"></i>
                    <span class="menu-text">
            ...
            <li class="menu-item-settings">
                <a href="https://cleanair.bihar.gov.in/admin/settings" aria-expanded="false">
                    <i class=" menu-icon"></i>
                    <span class="menu-text">
                        Settings             </span>
                </a>
    ...
    <aside id="menu" class="sidebar">
        <ul class="nav metis-menu" id="side-menu">
                ...
                <!-- <img src="https://cleanair.bihar.gov.in/assets/images/white-logo-placeholder.jpg" alt="" > -->
                    ...
                    <li class="menu-item profile-link hide">
                        ...
                        <div class="profile-info">
                            ...
                            <!-- <ul class="staff_location" data-toggle="tooltip" data-html="true" title="Bihar" data-placement="bottom"> -->
                    ...
                    <!-- <li class="quick-links">
                        <div class="dropdown dropdown-quick-links">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownQuickLinks">
                                <li>
                                    <a href="https://cleanair.bihar.gov.in/admin/clients/client" >
                                        <i class="fa fa-plus-square-o"></i>
                                        Customer                  </a>
                                </li>
                                <li>
                                    <a href="https://cleanair.bihar.gov.in/admin/projects/project" >
                                        <i class="fa fa-plus-square-o"></i>
                                        Project                  </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://cleanair.bihar.gov.in/admin/tickets/add" >
                                        <i class="fa fa-plus-square-o"></i>
                                        Ticket                  </a>
                                </li>
                                <li>
                                    <a href="https://cleanair.bihar.gov.in/admin/staff/member" >
                                        <i class="fa fa-plus-square-o"></i>
                                        Staff Member                  </a>
                                </li>
                                <li>
                                    <a href="https://cleanair.bihar.gov.in/admin/utilities/calendar?new_event=true&date=04-06-2025" >
                                        <i class="fa fa-plus-square-o"></i>
                                        Event                  </a>
                                </li>
                            </ul>
                    ...
                    <li class="menu-item-dashboard" >
                        <a href="https://cleanair.bihar.gov.in/admin/" aria-expanded="false" >
                            <i class="fa fa-home menu-icon"></i>
                            <span class="menu-text">
                                My Action Items          </span>
                        </a>
                    </li>
                    <li class="menu-item-dashboardchecklist" >
                    ...
                    <li class="menu-item-manage-geography" >
                        <a href="#" aria-expanded="false" >
                        ...
                        <ul class="nav nav-second-level collapse" aria-expanded="false">
                            <li class="sub-menu-item-region" >
                                <a href="https://cleanair.bihar.gov.in/admin/region" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> City                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-org" >
                                <a href="https://cleanair.bihar.gov.in/admin/staff/organization" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Organization                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-wm" >
                                <a href="https://cleanair.bihar.gov.in/admin/manageward" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Geographical Unit                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-subregion" >
                                <a href="https://cleanair.bihar.gov.in/admin/subregion" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Zone                  </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item-categories" >
                        <a href="https://cleanair.bihar.gov.in/admin/issues_manage/" aria-expanded="false" >
                            ...
                            <span class="menu-text">
                                Manage Action Items          </span>
                        </a>
                    </li>
                    <li class="menu-item-manage-user" >
                        <a href="#" aria-expanded="false" >
                            <i class="fa fa-user menu-icon"></i>
                            <span class="menu-text">
                                Manage Users          </span>
                        ...
                        <ul class="nav nav-second-level collapse" aria-expanded="false">
                            <li class="sub-menu-item-ae-area" >
                                <a href="https://cleanair.bihar.gov.in/admin/staff?role=ae-area" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> State Observer                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-ar" >
                                <a href="https://cleanair.bihar.gov.in/admin/staff?role=ar" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Reviewer                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-at" >
                                <a href="https://cleanair.bihar.gov.in/admin/staff?role=at" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Project Leader                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-ata" >
                                <a href="https://cleanair.bihar.gov.in/admin/staff?role=ata" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Project Support                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-qc" >
                                <a href="https://cleanair.bihar.gov.in/admin/staff?role=qc" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Surveyor QC                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-sv" >
                                <a href="https://cleanair.bihar.gov.in/admin/staff?role=sv" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Surveyor                  </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item-master_plan" >
                        <a href="#" aria-expanded="false" >
                            <i class="fa fa-file-pdf-o menu-icon"></i>
                            <span class="menu-text">
                                City Action Plan          </span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level collapse" aria-expanded="false">
                            <li class="sub-menu-item-view_master_plan" >
                                <a href="https://cleanair.bihar.gov.in/admin/cityplan/view" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> View City Action Plan                  </span>
                                </a>
                            </li>
                            <li class="sub-menu-item-edit_master_plan" >
                                <a href="https://cleanair.bihar.gov.in/admin/cityplan" target="" >
                                    <span class="sub-menu-text">
                                        <i class="fa fa-angle-right mR10"></i> Edit City Action Plan                  </span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="">
                <a href="https://cleanair.bihar.gov.in/admin/authentication/logout"> <i class="fa fa-power-off menu-icon"></i>
                    <span class="menu-text">Logout</span>
                </a>
            </li>
        </ul>
        <div class="profile-info powered-by hide">
            <span>An initiative by</span> <img src="https://cleanair.bihar.gov.in/assets/images/powered-by.png" alt="">
        </div>
    </aside>
    ...
    <div id="wrapper">
        <div class="content">
            <div class="new-dashboard">
                <h2 class="action-head" style="text-align:right;"> <a href="https://cleanair.bihar.gov.in/admin/dashboard/mapview" class="gm-filter-container" style=" width:10%"><button class="" type="button">View On Map</button></a></h2>
                <div class="summary-section">
                    ...
                    <input type="hidden" name="action_item_list" class="action_item_list"
                        ...
                        <ul class="nav nav-tabs dashboard-tab">
                            <li class="active action_items_data"><a href="#action-items" data-toggle="tab">Unassigned (<span
                                class="action_items_cnt1" style=display:none;>0/</span><span id="thispageTablecount">0</span>)</a></li>
                        <li class="verified_data"><a href="#verified-deadlines" data-toggle="tab" style="display:flex;align-items:center;"> Verify<span class="rpru">(Resolved/ Partially Resolved/ Unresolved)</span><span style="margin-left:5px;">(<span class="verified_cnt">0</span>/<span id="verified_view_cnt">0</span>)</span></a>
                        </li>
                    </ul>
