...
export default function ProductDetails() {
  return (
    <>
    <Breadcrumb pageTitle="Shop" pageSubTitle="Details" />
          ...
          <div className="col-lg-7 h-auto mb-30">
            <div className="h-100 bg-light p-30">
              ...
              <p className="mb-4">
                ...
                ipsum et, labore clita lorem magna duo dolor no sea Nonumy
              </p>
              <div className="d-flex mb-3">
              ...
              <div className="tab-content">
                <div className="tab-pane fade show active" id="tab-pane-1">
                  ...
                  <p>
                    ...
                    ipsum rebum diam. Dolore diam stet rebum sed tempor kasd
                    eirmod. Takimata kasd ipsum accusam sadipscing, eos dolores sit
                    no ut diam consetetur duo justo est, sit sanctus diam tempor
                    aliquyam eirmod nonumy rebum dolor accusam, ipsum kasd eos
                    consetetur at sit rebum, diam kasd invidunt tempor lorem, ipsum
