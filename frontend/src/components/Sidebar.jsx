            ...
            <ul className="nav metis-menu" id="side-menu">
                ...
                <li className="menu-item-dashboard">
                    <Link to="/users">
                        ...
                        <span className="menu-text">Mamnage Users</span>
                ...
                <li className="menu-item-master_plan">
                    <a href="#" aria-expanded="false" target="_blank">
                    ...
                    <ul className="nav nav-second-level collapse" aria-expanded="false">
                        <li className="sub-menu-item-view_master_plan">
                            <a href="https://cleanair.bihar.gov.in/admin/cityplan/view" target="_blank">
                                <span className="sub-menu-text">
