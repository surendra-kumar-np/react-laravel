...
(function() {
    ...
    Autoplay.prototype.controls = function() {
        var _this = this;
        var _html = '<button type="button" aria-label="Toggle autoplay" class="lg-autoplay-button lg-icon d-none"></button>';
    ...
    Fullscreen.prototype.init = function() {
        ...
        if (this.core.s.fullScreen) {
            ...
            if (!document.fullscreenEnabled && !document.webkitFullscreenEnabled &&
                ...
                fullScreen = '<button type="button" aria-label="Toggle fullscreen" class="lg-fullscreen lg-icon d-none"></button>';
...
(function() {
    ...
    Zoom.prototype.init = function() {
        ...
        if (_this.core.s.actualSize) {
            zoomIcons += '<button type="button" aria-label="Actual size" id="lg-actual-size" class="lg-icon d-none"></button>';
        }
...
(function() {
    ...
    Share.prototype.init = function() {
        ...
        var shareHtml = '<button type="button" aria-label="Share" id="lg-share" class="lg-icon d-none" aria-haspopup="true" aria-expanded="false">' +
